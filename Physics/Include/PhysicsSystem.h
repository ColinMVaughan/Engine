...
public:
	...
	//	Generates Scene from description, fills in some boilerplate info, and sets up the scene for PVD
	//
	//	Params: 
	//	- a_SceneDescription: settings for the scene that will be created
	//
	//	Returns:
	//	-Pointer to the newly created scene. User owns pointer, responsible for deletion. 
	//----------------------------------------------------------------------------------------------------
